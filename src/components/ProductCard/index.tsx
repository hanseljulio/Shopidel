  ...
  return (
    <div
      ...
      className={classNames([
        "w-full group transform items-start justify-start  hover:scale-95 h-fit md:w-full object-cover overflow-hidden shadow-md group-hover:shadow-none cursor-pointer rounded-md flex flex-col align-middle  transition-all duration-500 ease-in-out text-left",
      ])}
    >
