...
const Search = () => {
  ...
  return (
    <>
      {
        isModal && <Modal content={contentModal!} onClose={() => setIsModal(false)} />
      }
      <Navbar />
      <div className='py-8'>
...
const SortModal = () => {
  return (
    <div className='flex flex-col gap-y-5'>
      ...
      <Button text='Apply' styling='w-full bg-[#29374e] p-2  rounded-md text-white' />
    </div>
  )
...
const FilterModal = () => {
  return (
    <>
      ...
      <Button text='Apply' styling='w-full bg-[#29374e] p-2 mt-5 rounded-md text-white' />
    </>
  )
}
