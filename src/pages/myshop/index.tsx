            ...
            <div className='flex h-screen justify-center items-center'>
                ...
                <div className='flex max-w-7xl w-full justify-around'>
                    ...
                    <div className=' flex flex-col justify-center w-96'>
                        <h1>Hi, <span className='font-bold'>Kevin Joshua Pulung</span></h1>
                        <p className='text-sm'>Lets start your journey as a seller</p>
                        <form className='mt-5 flex flex-col gap-y-5' onSubmit={handleSubmit(registerMerchantHandler)}>
                            <div className='flex flex-col'>
                                ...
                                })} name="name" id="name" className='rounded-md border p-2' />
                                {errors.name?.types === errors.name?.types?.validate && <p role='alert' className='text-xs text-red-500 mt-1'>{errors.name?.message}</p>}
                            </div>
                            <div className='flex flex-col'>
                            ...
                            <div className='mt-5'>
                                <Button text='Register my shop' styling='p-2 bg-[#364968] w-full rounded-md text-white' />
                            </div>
                        </form>
                    </div >
                </div >
